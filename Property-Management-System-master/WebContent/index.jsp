...
<div class="row">
            ...
            <div class="box-content row">
              ...
              <!--      <p><b>All pages in the menu are functional, take a look at all, please share this with your
                 ...
                 <!--    <p class="center-block download-buttons">
                        <a href="https://blog.csdn.net/weixin_43654123/category_12222409.html" class="btn btn-primary btn-lg"><i
                                class="glyphicon glyphicon-chevron-left glyphicon-white"></i> Back to article</a>
                        <a href="https://blog.csdn.net/weixin_43654123/category_12222409.html" class="btn btn-default btn-lg"><i
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright"><a href="https://blog.csdn.net/weixin_43654123/category_12222409.html" target="_blank">&copy;
                </a> </p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a
                href="https://blog.csdn.net/weixin_43654123/category_12222409.html">jinyindedouzi</a></p>
    </footer>
