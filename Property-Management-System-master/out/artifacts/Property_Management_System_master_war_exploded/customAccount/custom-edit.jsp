	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="custom?action=customAccountEdit" method="post">
                    <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" >用户名*</label>
							<input type="text" class="form-control" name="username" value="${customAccount.username}" required>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="ownerid" value="${customAccount.ownerid}" required>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="carid" value="${customAccount.carid}">
							<span class="help-block with-errors"></span>
						</div>
					</div>		
